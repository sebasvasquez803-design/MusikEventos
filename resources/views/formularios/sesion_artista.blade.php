...
<head>
    ...
    <title>Registro | Artista solista</title>
...
<div class="auth-layout">
    ...
    <main class="auth-content">
        <section class="auth-panel">
            <h2 class="auth-title">Registrar artista solista</h2>
            ...
            <form method="POST" action="{{ route('register.artista') }}">
                ...
                <div class="auth-field">
                    ...
                    <input id="name" name="name" type="text" value="{{ old('name') }}" placeholder="Tu nombre completo" required autocomplete="name">
            ...
            <p class="auth-register">¿Ya tienes cuenta? <a href="{{ route('iniciar.rep.leg') }}">Inicia sesión</a></p>
        </section>
    </main>
</div>
